...
public class GeneralHelper
{
	...
	private static final Pattern PATTERN_CM_PHONE = Pattern.compile("^(134|135|136|137|138|139|147|150|151|152|157|181|182|183|187|188)\\d{8}$");
	...
	/**检查手机号码是否合法且为中国移动手机号**/
    public final static boolean isCMPhone(String phone) {
		return PATTERN_CM_PHONE.matcher(phone).matches();
	}
